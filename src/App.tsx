        ...
        <main className='flex-1 p-6 flex gap-6'>
          ...
          <aside className="w-72 space-y-5">
            <form className="space-y-6">
              <label 
                htmlFor="video" 
                className="border flex rounded-md aspect-video cursor-pointer border-dashed text-sm flex-col gao-2 items-center justify-center text-muted-foreground hover:bg-primary/5"
              >
